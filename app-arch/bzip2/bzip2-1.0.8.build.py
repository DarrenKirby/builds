...
def install(self):
    ...
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzcmp.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzdiff.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzegrep.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzfgrep.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzgrep.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzip2.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzless.1", self.p['man1'])
    self.inst_manpage(f"{self.seg_dir}/usr/man/man1/bzmore.1", self.p['man1'])
