...
def install(self):
    ...
    self.inst_binary(f"{self.p['_ub']}/xzdiff", f"{self.p['ub']}")
    self.inst_binary(f"{self.p['_ub']}/xzgrep", f"{self.p['ub']}")
    self.inst_binary(f"{self.p['_ub']}/xzless", f"{self.p['ub']}")
    self.inst_binary(f"{self.p['_ub']}/xzmore", f"{self.p['ub']}")
